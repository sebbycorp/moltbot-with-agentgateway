...
This demo runs **AgentGateway inside Kubernetes** (Kind or any cluster) while **Moltbot runs on your local machine**. Moltbot connects to messaging platforms (WhatsApp, Telegram, etc.) and routes all LLM API calls through AgentGateway for security and observability.

```
┌─────────────────────┐          ┌─────────────────────────────────────────────┐
│   Your Machine      │          │        Kubernetes (Kind/EKS/GKE)            │
│                     │          │                                             │
│  ┌───────────────┐  │   HTTP   │  ┌─────────────────────────────────────┐   │
│  │               │  │ ──────►  │  │         AgentGateway                │   │
│  │    Moltbot    │  │ NodePort │  │  ┌─────────────────────────────┐   │   │
│  │   (Clawdbot)  │  │          │  │  │     Security Policies       │   │   │
│  │               │  │          │  │  │  • PII Protection           │   │   │
│  │  ┌─────────┐  │  │          │  │  │  • Jailbreak Prevention     │   │   │
│  │  │ Claude  │  │  │          │  │  │  • Credential Blocking      │   │   │
│  │  │   API   │  │  │          │  │  │  • Rate Limiting            │   │   │
│  │  │ Client  │  │  │          │  │  └─────────────────────────────┘   │   │
│  │  └─────────┘  │  │          │  │                 │                   │   │
│  │       │       │  │          │  │                 ▼                   │   │
